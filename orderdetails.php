                    ...
                    <?php   
                      ...
                      while ($row = $qry->fetch(PDO::FETCH_ASSOC)) {$i++;?>
                        <tr>
                          ...
                          <td>
                            <button class="btn btn-warning" onclick="javascript:window.location='order.php?order-id=<?=$row['order_id']?>';">Edit</button>|<button class="btn btn-danger" onclick="javascript:window.location='orderdetails.php?del-id=<?=$row['order_id']?>';">Delete</button>|<button class="btn btn-info" onclick="javascript:window.location='barcode-show.php?order-id=<?=$row['order_id'];?>'">Barcodes</button>
